...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.mahmood.inventoryapp2/inventories" will map to the
        ...
        // For example, "content://com.example.mahmood.inventoryapp2/inventories/3" matches, but
        // "content://com.example.mahmood.inventoryapp2/inventories" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case INVENTORY_ID:
                ...
                // This will perform a query on the products table and return a
